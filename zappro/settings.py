...
AUTORESPOSTA_DELAY_SEGUNDOS = 7
AUTORESPOSTA_DELAY_VARIACAO_SEGUNDOS = 5
AUTORESPOSTA_MOSTRAR_DIGITANDO = True
BOAS_VINDAS_INTERVALO_MINUTOS = 20
# Proteções contra rajadas e repetição. Podem ser ajustadas no .env.
AUTORESPOSTA_COOLDOWN_CONTATO_SEGUNDOS = int(
    os.environ.get("AUTORESPOSTA_COOLDOWN_CONTATO_SEGUNDOS", "15")
)
AUTORESPOSTA_REPETIDA_INTERVALO_MINUTOS = int(
    os.environ.get("AUTORESPOSTA_REPETIDA_INTERVALO_MINUTOS", "5")
)
AUTORESPOSTA_MAX_POR_CONTATO_HORA = int(
    os.environ.get("AUTORESPOSTA_MAX_POR_CONTATO_HORA", "10")
)
